  ...
  return (
    <div className="min-h-screen flex flex-col bg-transparent text-[var(--text)]">
      ...
      <main className="flex-1 max-w-lg mx-auto w-full px-4 py-8">
          <div className="bg-[var(--bg2)] border border-[var(--border)] rounded-[14px] overflow-hidden flex flex-col" style={{ maxHeight: "calc(100vh - 180px)" }}>
            {/* Header */}
            ...
            <nav className="flex-1 overflow-y-auto px-3 py-3 min-h-0">
              {filtered.length === 0 && (
                <p className="text-center text-[var(--text3)] text-sm py-6">No challenges match this filter.</p>
              )}
