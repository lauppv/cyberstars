...
function CyberStarsApp() {
  ...
  return React.createElement('div', {
    ...
    /* ── XP Bar ── */
    gamFull && React.createElement(XPBar, { current: xp, max: 300, level: 4 }),
    ...
    React.createElement('div', { className: 'main-layout' },
      ...
      sidebarOpen && React.createElement('aside', { className: 'sidebar' },
        ...
        gamFull && React.createElement('div', { className: 'sidebar-badges' },
          React.createElement('div', { className: 'badges-title' }, 'Badges'),
          React.createElement('div', { className: 'badges-grid' },
            React.createElement(Badge, { icon: '🐍', label: 'First Code', earned: true }),
            React.createElement(Badge, { icon: '⚡', label: 'Speed Run', earned: true }),
            React.createElement(Badge, { icon: '🧠', label: 'Bug Squasher', earned: false }),
            React.createElement(Badge, { icon: '🌟', label: 'Perfect Score', earned: false })
          )
        )
      ),
