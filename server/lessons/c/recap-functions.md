...
Each line of input has three numbers. Process them one by one until op is 0. Remember: **power(2, 8)** means 2 * 2 * 2 * 2 * 2 * 2 * 2 * 2 = 256. Implement it with a while loop, **not** with a library function
