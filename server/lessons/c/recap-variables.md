Time to combine what you've learned so far! No new theory — just a challenge that uses **print**, **variables**, and **comments**
...
Total cost: 55.12 EUR
```

Use **%.2f** for floats with 2 decimal places
