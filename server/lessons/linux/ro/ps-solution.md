```bash
ps aux
ps aux | grep reactor > stare-reactor.txt
mkdir verificare-stare
mv stare-reactor.txt verificare-stare/
wc -l verificare-stare/stare-reactor.txt
```
...
1 verificare-stare/stare-reactor.txt
```
