...
Write a program that displays *it's freezing outside* if the **temperature** is below **0** degrees, or *water does not freeze*

Here at **CyberStars**, we encourage **learning** and **curiosity**. Programming is learned through **curiosity**. Ask yourself *what happens if I change this?* Play around with variables and **if-else**. This can actually be fun 