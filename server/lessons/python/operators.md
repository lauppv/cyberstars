...
```
This will print **8**, because **2 * 2 * 2 = 8**. The **\*\*** operator means **power**. So **5 ** 2** is **25**, **3 ** 4** is **81**, and so on
...
1419857
```
Play around with the values and see how the output changes. **Run** the code as many times as you want :)
