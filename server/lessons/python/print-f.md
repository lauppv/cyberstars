...
Obviously, **name**, **age**, and **height** are the variables. The **{}** symbols work as a *placeholder*. Inside them, if you put a variable, the **variable’s name will be replaced by its value**
